...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Sparkle decorations */}
      <Sparkle className="top-[15%] left-[10%]" delay={0} />
      <Sparkle className="top-[25%] right-[15%]" delay={1.2} />
      <Sparkle className="bottom-[30%] left-[20%]" delay={0.6} />
      <Sparkle className="top-[40%] right-[25%]" delay={2} />
      <Sparkle className="bottom-[20%] right-[10%]" delay={1.5} />
      <Sparkle className="top-[60%] left-[8%]" delay={0.8} />
      ...
      >
        <motion.p
          className="text-rose-light/60 text-xs md:text-sm tracking-[0.4em] uppercase mb-6 font-inter"
        ...
        <h1 className="font-playfair text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] font-bold tracking-tight leading-none">
        ...
        <motion.span
          className="inline-block text-4xl md:text-5xl ml-2"
        ...
        <motion.div
          className="mx-auto mt-4 h-px w-32 md:w-48 bg-gradient-to-r from-transparent via-gold/40 to-transparent"
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
        ...
        >
          <p className="font-inter text-lg md:text-xl text-rose/60 italic">
        ...
        <motion.button
          ...
          className="mt-12 md:mt-14 px-10 py-4 rounded-full
          ...
          style={{
            boxShadow: "0 0 30px rgba(155, 35, 53, 0.3), 0 0 60px rgba(155, 35, 53, 0.1), inset 0 1px 0 rgba(255,255,255,0.1)",
          }}
